...
global w_ae_spb_workflow w_ae_spb_workflow
...
Private:
	...
	String	isBmpEdite_Oui
	String	isBmpEdite_Non
	String	isBmpRout_Oui
	String	isBmpRout_Non

end variables

on ue_imprimerdossier;call w_8_accueil_edition::ue_imprimerdossier;//*-----------------------------------------------------------------
//*
//* Objet			:	w_ae_spb_workflow
//* Evenement 		:	ue_imprimmerDossier
//* Auteur			:	La Recrue
//* Date				:	09/09/97 15:52:05
//* Libell$$HEX4$$e900090009000900$$ENDHEX$$:	Pour chaque dossier, L'impression bloque les dossiers
//* Commentaires	:	si le blocage ne fonctionne pas l'impression ne sera pas appel$$HEX1$$e900$$ENDHEX$$e
//*						dans le cas contraire l'ev$$HEX1$$e800$$ENDHEX$$nement d'impression est appel$$HEX1$$e900$$ENDHEX$$. A la fin
//*						de l'impression, le dossier est d$$HEX1$$e900$$ENDHEX$$bloqu$$HEX2$$e9002000$$ENDHEX$$est passe $$HEX2$$e0002000$$ENDHEX$$l'$$HEX1$$e900$$ENDHEX$$tat 5 si
//*						l'impression s'est bien pass$$HEX1$$e900$$ENDHEX$$e sinon il reste $$HEX2$$e0002000$$ENDHEX$$l'$$HEX1$$e900$$ENDHEX$$tat 3
//*				  
//*-----------------------------------------------------------------
...
dw_1.istCol[9].sHeaderName=	"Ed"
dw_1.istCol[9].sAlignement= 	"1"
dw_1.istCol[9].ilargeur	=	2
dw_1.istCol[9].sValues		= 	isBmpEdite_Oui + "	O/" + isBmpEdite_Non + " 	N"
...
Dw_1.isJointure 	= " and sysadm.w_queue.cod_etat = '3' and sysadm.w_queue.alt_occupe = 'N' order by sysadm.w_queue.trv_maj_le"
...
on w_ae_spb_workflow.create
call super::create
end on

on w_ae_spb_workflow.destroy
call super::destroy
if IsValid(MenuID) then destroy(MenuID)
end on

type cb_debug from w_8_accueil_edition`cb_debug within w_ae_spb_workflow
end type

type pb_retour from w_8_accueil_edition`pb_retour within w_ae_spb_workflow
integer width = 242
integer height = 144
end type

type pb_interro from w_8_accueil_edition`pb_interro within w_ae_spb_workflow
integer x = 270
integer width = 242
integer height = 144
end type

type pb_creer from w_8_accueil_edition`pb_creer within w_ae_spb_workflow
end type

type dw_1 from w_8_accueil_edition`dw_1 within w_ae_spb_workflow
integer y = 740
integer width = 3360
end type

type pb_tri from w_8_accueil_edition`pb_tri within w_ae_spb_workflow
integer x = 521
integer width = 242
integer height = 144
end type

type pb_imprimer from w_8_accueil_edition`pb_imprimer within w_ae_spb_workflow
end type

type pb_word from w_8_accueil_edition`pb_word within w_ae_spb_workflow
integer x = 773
integer width = 242
integer height = 144
end type

type mle_rapport from w_8_accueil_edition`mle_rapport within w_ae_spb_workflow
integer x = 32
integer y = 192
integer width = 3365
integer height = 408
...
type cb_tous from w_8_accueil_edition`cb_tous within w_ae_spb_workflow
integer y = 620
end type

type cb_aucun from w_8_accueil_edition`cb_aucun within w_ae_spb_workflow
integer y = 620
end type

type st_1 from w_8_accueil_edition`st_1 within w_ae_spb_workflow
integer x = 2336
integer y = 632
end type

type st_nombre from w_8_accueil_edition`st_nombre within w_ae_spb_workflow
integer x = 3104
integer y = 628
end type

type cbx_banner from w_8_accueil_edition`cbx_banner within w_ae_spb_workflow
end type

type cbx_pageblanche from w_8_accueil_edition`cbx_pageblanche within w_ae_spb_workflow
end type
