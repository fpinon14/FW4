HA$PBExportHeader$u_gs_corb_oper_envspb.sru
forward
global type u_gs_corb_oper_envspb from nonvisualobject
end type
end forward

global type u_gs_corb_oper_envspb from nonvisualobject
end type
global u_gs_corb_oper_envspb u_gs_corb_oper_envspb
...
sMoteur	= Upper ( ProfileString ( stGLB.sFichierIni, "GUPTA ENVSPB", "DBMS", "" ) )

If	sMoteur = "GUPTA" Then
	bRet = f_ConnectGupta ( stGLB.sFichierIni, "GUPTA ENVSPB", trEnvSpb, stGLB.sMessageErreur )
	sDataObjet = "d_Operateur_Application_GUP"
Else
	bRet = f_ConnectSqlServer ( stGLB.sFichierIni, "GUPTA ENVSPB", trEnvSpb, stGLB.sMessageErreur, stGLB.sLibCourtAppli, stGLB.sCodOper )
...
on u_gs_corb_oper_envspb.create
call super::create
TriggerEvent( this, "constructor" )
end on

on u_gs_corb_oper_envspb.destroy
