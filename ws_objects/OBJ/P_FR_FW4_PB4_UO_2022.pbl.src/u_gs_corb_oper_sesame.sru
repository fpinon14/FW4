HA$PBExportHeader$u_gs_corb_oper_sesame.sru
$PBExportComments$---} Objet qu'il fudra renommer en u_gs_corb_oper lors de l'installation de SESAME. L'ancien se nommera alors u_gs_corb_oper_envspb.
forward
global type u_gs_corb_oper_sesame from nonvisualobject
end type
end forward

global type u_gs_corb_oper_sesame from nonvisualobject
end type
global u_gs_corb_oper_sesame u_gs_corb_oper_sesame
...
on u_gs_corb_oper_sesame.create
call super::create
TriggerEvent( this, "constructor" )
end on

on u_gs_corb_oper_sesame.destroy
