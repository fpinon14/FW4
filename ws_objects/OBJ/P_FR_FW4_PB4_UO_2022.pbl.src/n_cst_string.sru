...
$PBExportComments$/* DCMP 060694 */ Import du n_cst_sstring des pfc pour fournir des service de manipulation de chaine
forward
...
//	Version
//	5.0   Initial version
//	[O2M_DIAG_NOMADE].lot2 PHG, 05/01/2009, Function modified as below :
//	Not existing keyword will be added. the -1 error code will not occurs now.
//  #1 PHG correction affection r$$HEX1$$e900$$ENDHEX$$sultat.
// #2 - FPI - 11/03/2010 - [20100311.FPI] Correction cl$$HEX3$$e9002000e900$$ENDHEX$$crite en double
//////////////////////////////////////////////////////////////////////////////
//
//	Copyright $$HEX2$$a9002000$$ENDHEX$$1996-1997 Sybase, Inc. and its subsidiaries.  All rights reserved.
//	Any distribution of the PowerBuilder Foundation Classes (PFC)
...
do 
	...
	else // [O2M_DIAG_NOMADE].Lot2 : Not existing keyword will be added.
		if  li_Found < 1 Then				// #2 - [20100311.FPI] 
			  // The -1 error code will not occurs now.
			if of_isempty( as_source ) then
				as_source=trim(as_keyword)+"="+trim(as_keyvalue)
			else
				// #1 '+=' instead of '=' 
				as_source+=trim(as_separator)+trim(as_keyword)+"="+trim(as_keyvalue)
			End If
			li_found=1
		End if								// #2 - [20100311.FPI] 
	End if
