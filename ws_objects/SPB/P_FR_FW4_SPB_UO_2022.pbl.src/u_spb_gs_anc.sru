HA$PBExportHeader$u_spb_gs_anc.sru
$PBExportComments$---} User Object de contr$$HEX1$$f400$$ENDHEX$$le de gestion anc$$HEX1$$ea00$$ENDHEX$$tre
forward
global type u_spb_gs_anc from nonvisualobject
end type
end forward

global type u_spb_gs_anc from nonvisualobject
end type
global u_spb_gs_anc u_spb_gs_anc
...
on u_spb_gs_anc.create
TriggerEvent( this, "constructor" )
end on

on u_spb_gs_anc.destroy
